...
//	}
	...
	public Map<String, Object> checkCode(CodeGroup dto) throws Exception {
	...
	@ResponseBody
	@RequestMapping(value = "checkCodeAnother")
	public Map<String, Object> checkCodeAnother(CodeGroup dto) throws Exception {

		Map<String, Object> returnMap = new HashMap<String, Object>();
		
		int result = service.selectOneCodeAnotherCheck(dto);
